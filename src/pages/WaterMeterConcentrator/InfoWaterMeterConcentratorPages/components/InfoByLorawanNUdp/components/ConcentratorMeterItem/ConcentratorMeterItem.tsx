...
export const ConcentratorMeterItem: FC<PropsType> = ({ setSelectedMeterObjCallback, meterData, sideBarToggle }) => {
  ...
  return (
    <div className="water-concentrator-meter-item">
      <Row className="water-concentrator-meter-item__header " style={{ wordWrap: "break-word" }}>
        ...
        <Col xl={1} lg={1} md={4} sm={4} style={{ display: "flex", justifyContent: "flex-end", paddingRight: "35px" }}>
          <Popover
            ...
            positions={["top", "right"]}
            padding={0}
            containerClassName="water-lorawan-udp-concentrator-popover__container "
            content={
              <div className="water-lorawan-udp-concentrator-popover">
                <div className="water-lorawan-udp-concentrator-popover__item" onClick={sideBarToggle(true)}>
                  <InfoIcon />
                  <span>Информация</span>
                </div>
                <div
                  className="water-lorawan-udp-concentrator-popover__item"
                  onClick={(e) => {
                    history.push(
                      `/admin/concentrators/water-meter/concentrator-info/edit?meterId=${meterData.id}&meterName=${
                        meterData.deviceName
                      }${
          ...
          >
            <div
              ...
              className={
                isSvgHovered
                  ? "water-concentrator-meter-item__icon water-concentrator-meter-item__icon--hovered d-flex justify-content-center align-items-center"
                  : "water-concentrator-meter-item__icon d-flex justify-content-center align-items-center"
              }
            >
              {meterData.userId ? (
