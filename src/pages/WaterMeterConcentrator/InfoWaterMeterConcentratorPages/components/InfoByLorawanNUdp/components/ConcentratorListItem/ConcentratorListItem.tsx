...
export const ConcentratorListItem: FC<PropsType> = (props) => {
  ...
  const { setSelectedConcentrator, name, gatewayID, id, sideBarToggle } = props;
  ...
  return (
    <div
      ...
      className="info-water-lorawan-udp-concentrators-list__item d-flex justify-content-between align-items-center"
    >
      ...
      <div className="d-flex align-items-center">
        ...
        >
          <div
            ...
            className={
              isSvgHovered
                ? "info-water-lorawan-udp-concentrators-list__icon info-water-lorawan-udp-concentrators-list__icon--hovered d-flex justify-content-center align-items-center"
                : "info-water-lorawan-udp-concentrators-list__icon d-flex justify-content-center align-items-center"
            }
          >
