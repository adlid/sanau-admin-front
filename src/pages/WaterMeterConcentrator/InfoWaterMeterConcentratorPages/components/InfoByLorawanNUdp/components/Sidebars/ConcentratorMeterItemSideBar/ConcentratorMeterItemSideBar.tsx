...
export const ConcentratorMeterItemSideBar: FC<IConcentratorItemSideBarProps> = (props) => {
  ...
  return (
    <>
      <div>
        <div className="water-concentrator-item-sidebar">
          <div className="water-concentrator-item-sidebar__header">
            <Close onClick={close} style={{ cursor: "pointer" }} />
            <div>
              <p className="water-concentrator-item-sidebar__header_title">{selectedMeterObj?.deviceName}</p>
              <p className="water-concentrator-item-sidebar__header_text">Информация</p>
            </div>
          </div>

          <div className="water-concentrator-item-sidebar__body_title">Прибор учета</div>
          ...
          <div className="water-concentrator-item-sidebar__body">
            ...
            <div className="item">
              <h2 className="text">Коэффициент импульса</h2>
              <div style={{ display: "flex" }}>
          ...
          <div className="water-concentrator-item-sidebar__body_title">Контрагент</div>
          ...
          <div className="water-concentrator-item-sidebar__footer">
            <MainButton
              title="Изменить"
              style={{ width: 126, height: 40, fontSize: 14 }}
              onClick={() =>
                history.push(
                  `/admin/concentrators/water-meter/concentrator-info/edit?meterId=${selectedMeterObj?.id}&meterName=${
                    selectedMeterObj?.deviceName
                  }${
