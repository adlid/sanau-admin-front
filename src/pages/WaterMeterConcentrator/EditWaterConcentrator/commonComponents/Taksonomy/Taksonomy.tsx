...
import { waterConcentratorGroupControlThunk } from "../../../../../store/slicesAndThunks/waterConcentrator/lorawanUdpDevice/lorawanUdpDevice.thunk";
...
export const Taksonomy: FC<PropsType> = (props) => {
  ...
  const getGroupControlData = async () => {
    setDataLoading(true);
    await dispatch(waterConcentratorGroupControlThunk(meterId));
