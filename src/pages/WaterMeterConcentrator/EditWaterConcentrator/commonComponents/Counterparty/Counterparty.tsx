...
export const Counterparty: FC<PropsType> = ({ formik, waterConcentratorPersonalAccountSearchCallback }) => {
  return (
    <div className="edit-water-concentrator-counterparty">
      <div className="edit-water-concentrator-counterparty__header d-flex">
        ...
        <div className="edit-water-concentrator-counterparty__btn" style={{ marginTop: "31px" }}>
          <MainButton
            isSecondary
            ...
            onClick={(e) => {
              e.preventDefault();
              waterConcentratorPersonalAccountSearchCallback();
            }}
          />
        </div>
      </div>

      <div className="edit-water-concentrator-counterparty__border">
        <div className="edit-water-concentrator-counterparty__role d-flex">
          <Form.Group>
            <Form.Check
        ...
        {formik.values.roleName === "ROLE_LEGAL" && (
          <Form.Group className="concentrator-character__form-item edit-water-concentrator-counterparty__input">
      ...
      <div className="edit-water-concentrator-counterparty__border">
        ...
        <div className="d-flex">
          ...
          <div className="mr16px"></div>
          <Form.Group className="concentrator-character__form-item edit-water-concentrator-counterparty__short-input">
