...
export const GasGroups: FC<IGroupsProps> = (props) => {
  ...
  const onItemChange = (key: string) => history.push(`/admin/system/groups-control/edit-group/gas?groupId=${key}`);
  ...
  return (
    <>
      ...
      <div className="gas-group-change-list">
        <div className="gas-group-change-list__search-block">
          ...
          <MainButton
            ...
            onClick={(e) => {
              e.preventDefault();
              history.push({ search: `?tabValue=gas&state=edit` });
            }}
          />
          <AddButton
            title="Добавить группу"
            style={{ width: 235, height: 40, fontSize: 14 }}
            onClick={() => history.push("/admin/system/groups-control/create-group/gas")}
          />
        </div>
