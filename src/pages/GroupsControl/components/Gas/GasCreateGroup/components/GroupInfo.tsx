...
export const GroupInfo = (props: any) => {
  ...
  const [selectedMeterCategory, setSelectedMeterCategory] = useState<string>("gas");
  ...
  return (
    <Form onSubmit={formik.handleSubmit}>
      <div className="gas_create_group__title d-flex">
        <Form.Group className="operator-character__form-item">
          ...
          <div className="titleInputBox">
            <AppPopper
              gap="20px"
              content={
                <div className="gas_create_group__dropDownMenu">
            ...
            <Form.Control
              className="gas_create_group__input"
      ...
      <div className="gas_create_group__subtitleBox">
