...
export const SaveCancelBtns: FC<ISaveCancelBtnsProps> = (props) => {
  ...
  return (
    <div className="gas_create_group__btns d-flex" style={{ position: "absolute", bottom: 0, width: "100%" }}>
      <div>
        {pagination && (
          <Pagination
            page={pageNum || 1}
      ...
      <div className="d-flex">
        ...
        <MainButton
          ...
          onClick={() => history.push("/admin/system/groups-control?tabValue=gas&state=show")}
          isDisabled={dataSaving}
        />
      </div>
    </div>
