...
interface IGasGroupChangeProps {
  dataFetching: boolean;
}

export const GasGroupsChange: FC<IGasGroupChangeProps> = (props) => {
  ...
  return (
    <div className="gas-group-change-list">
      <div
        className="gas-group-change-list__search-block"
        style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}
      >
        <h2 className="gas-group-change-list__search-block_title">Изменить группировку</h2>
        <div className="gas-group-change-list__search-block" style={{ padding: "0px" }}>
          <MainButton
            isSecondary
            title="Отмена"
            ...
            onClick={(e) => {
              e.preventDefault();
              history.push({ search: `?tabValue=gas&state=show` });
            }}
          />
          <MainButton
      ...
      <div className="gas-group-change-list__body">
        {dataFetching ? (
