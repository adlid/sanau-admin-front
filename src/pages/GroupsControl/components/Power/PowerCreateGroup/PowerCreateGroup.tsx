...
export const PowerCreateGroup: FC<IPowerCreateGroupProps> = (props) => {
  ...
  const cantGoToTab = () => !groupId && enqueueSnackbar("Необходимо создать группу", { variant: "error" });

  return (
    <div className="power_create_group" style={{ background: "#FFFFFF", position: "relative" }}>
      <div className="power_create_group__tab tabs-type1">
        <h1 className="power_create_group__title" style={{ display: "flex", alignItems: "center", gap: "8px" }}>
