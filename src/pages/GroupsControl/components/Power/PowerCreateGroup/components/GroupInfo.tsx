...
export const GroupInfo = (props: any) => {
  ...
  const [selectedMeterCategory, setSelectedMeterCategory] = useState<string>("electric");
  ...
  return (
    <Form onSubmit={formik.handleSubmit}>
      <div className="power_create_group__title d-flex">
        <Form.Group className="operator-character__form-item">
          ...
          <div className="titleInputBox">
            <AppPopper
              gap="20px"
              content={
                <div className="power_create_group__dropDownMenu">
            ...
            <Form.Control
              className="power_create_group__input"
      ...
      <div className="power_create_group__subtitleBox">
