...
export const Taksonomy = (props: any) => {
  ...
  return (
    <>
      <div className="power_create_group__title" style={{ fontWeight: 400, marginBottom: "100px" }}>
        <GroupTreeChange orgData={state} setOrgData={setState} tabValue={tabValue} searchEnabled />
      </div>
