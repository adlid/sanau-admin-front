...
export const WaterCreateGroup: FC<IPowerCreateGroupProps> = (props) => {
  ...
  return (
    <div className="water_create_group" style={{ background: "#FFFFFF", position: "relative" }}>
      <div className="water_create_group__tab tabs-type1">
        <h1 className="water_create_group__title" style={{ display: "flex", alignItems: "center", gap: "8px" }}>
