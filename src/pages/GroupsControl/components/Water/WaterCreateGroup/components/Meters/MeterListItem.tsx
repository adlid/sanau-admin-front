...
export const MeterListItem: FC<PropsType> = memo((props) => {
  ...
  return (
    <>
      <Row className="water-meters-list-item__row">
        <Col
          xl={1}
          lg={1}
          md={4}
        ...
        <Col xl={1} lg={1} md={3} sm={3} className="water_create_group__table-group__column">
          <span className="water-meters-list-item__id">{meterData.serialNumber || "-"}</span>
        </Col>

        <Col xl={3} lg={3} md={3} sm={3} className="water_create_group__table-group__column">
          <span className="water-meters-list-item__id">{meterData.groupMeter.title || "-"}</span>
        </Col>

        <Col xl={3} lg={3} md={3} sm={3} className="water_create_group__table-group__column">
          <span className="water-meters-list-item__id">{meterData.userInfo?.personalAccountNumber || "-"}</span>
        </Col>

        <Col xl={4} lg={4} md={4} sm={4} className="water_create_group__table-group__column">
          <p
            className="water-meters-list-item__id"
