...
export const WaterGroups: FC<IGroupsProps> = (props) => {
  ...
  const onItemChange = (key: string) => history.push(`/admin/system/groups-control/edit-group/water?groupId=${key}`);
  ...
  return (
    <>
      ...
      <div className="water-group-change-list">
        <div className="water-group-change-list__search-block">
          ...
          <MainButton
            ...
            onClick={(e) => {
              e.preventDefault();
              history.push({ search: `?tabValue=water&state=edit` });
            }}
          />
          <AddButton
            title="Добавить группу"
            style={{ width: 235, height: 40, fontSize: 14 }}
            onClick={() => history.push("/admin/system/groups-control/create-group/water")}
          />
        </div>
