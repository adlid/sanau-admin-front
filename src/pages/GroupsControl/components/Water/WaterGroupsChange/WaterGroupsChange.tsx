...
interface IWaterGroupChangeProps {
  dataFetching: boolean;
}

export const WaterGroupsChange: FC<IWaterGroupChangeProps> = (props) => {
  ...
  return (
    <div className="water-group-change-list">
      <div
        className="water-group-change-list__search-block"
        style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}
      >
        <h2 className="water-group-change-list__search-block_title">Изменить группировку</h2>
        <div className="water-group-change-list__search-block" style={{ padding: "0px" }}>
          <MainButton
            isSecondary
            title="Отмена"
            ...
            onClick={(e) => {
              e.preventDefault();
              history.push({ search: `?tabValue=water&state=show` });
            }}
          />
          <MainButton
      ...
      <div className="water-group-change-list__body">
        {dataFetching ? (
