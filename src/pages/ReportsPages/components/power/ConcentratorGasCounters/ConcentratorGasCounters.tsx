...
import { ConcentratorGasCounterListItem } from "../ConcentratorGasCounterListItem/ConcentratorGasCounterListItem";
...
export const ConcentratorGasCounters: FC<IConcentratorWaterCountersProps> = (props) => {
  ...
  const fetchData = async () => {
    setDataLoading(true);
    await dispatch(getGroupTreeBySearchThunk({ query: '', type: 'gas', field: "title" }));
      ...
      <div className="reports__wrap">
        {dataLoading ? (
          ...
          tree.map((concentrator: any, index) => {
            return <ConcentratorGasCounterListItem
