...
export const ConcentratorWaterCounters: FC<IConcentratorWaterCountersProps> = (props) => {
  ...
  const fetchData = async () => {
    setDataLoading(true);
    await dispatch(getGroupTreeBySearchThunk({ query: '', type: 'water', field: "title" }));
    ...
    <div className="reports__table-block">
      ...
      <div className="reports__wrap">
        {dataLoading ? (
          ...
          tree.map((concentrator, index) => {
            return <ConcentratorWaterCounterListItem
