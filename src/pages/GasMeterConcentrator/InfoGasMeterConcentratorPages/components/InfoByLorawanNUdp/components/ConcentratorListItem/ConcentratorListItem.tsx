...
export const ConcentratorListItem: FC<PropsType> = (props) => {
  ...
  return (
    <div
      ...
      className="info-gas-lorawan-udp-concentrators-list__item d-flex justify-content-between align-items-center"
    >
      ...
      <div className="d-flex align-items-center">
        ...
        >
          <div
            ...
            className={
              isSvgHovered
                ? "info-gas-lorawan-udp-concentrators-list__icon info-gas-lorawan-udp-concentrators-list__icon--hovered d-flex justify-content-center align-items-center"
                : "info-gas-lorawan-udp-concentrators-list__icon d-flex justify-content-center align-items-center"
            }
          >
