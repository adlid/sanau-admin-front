...
export const ConcentratorsList: FC<PropsType> = ({ setSelectedConcentratorCallBack, allConcentrators }) => {
  ...
  return (
    <>
      ...
      <div className="info-gas-udp-concentrators-list">
        <div className="info-gas-udp-concentrators-list__header">
          <Search value={searchValue} onChange={(value: string) => setSearchValue(value)} />
        </div>
        <div className="info-gas-udp-concentrators-list__quantity">
          Всего UDP каналов: {allConcentrators.length}
        </div>

        <div className="info-gas-udp-concentrators-list__body">
          <div className="info-gas-udp-concentrators-list__list">
