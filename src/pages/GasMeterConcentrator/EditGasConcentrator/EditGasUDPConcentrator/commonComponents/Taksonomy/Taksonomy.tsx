...
import { gasConcentratorGroupControlThunk } from "../../../../../../store/slicesAndThunks/gasConcentrator/udpDevice/udpDevice.thunk";
...
export const Taksonomy: FC<PropsType> = (props) => {
  ...
  const getGroupControlData = async () => {
    setDataLoading(true);
    await dispatch(gasConcentratorGroupControlThunk(meterId));
