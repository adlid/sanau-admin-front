...
export const PowerMeterGPRSMainTable: FC<PropsType> = (props) => {
  const { parameterValue, tableData, token, page, totalPages, saveExcelCallBack, getTableInfoCallback } = props;
