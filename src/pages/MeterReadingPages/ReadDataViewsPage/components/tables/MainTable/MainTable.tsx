...
export const MainTable: FC<PropsType> = ({
  tableData,
  token,
  page,
  totalPages,
    ...
    <div className="main-table">
      <div className="read-data-view-table">
          ...
          <table className="table table-sm table-bordered">
            <thead>
              ...
              <tr className="read-data-view-table__bgc">
                ...
                {/* <th scope="col">Расход за период</th> */}
                <th scope="col" className="read-data-view-table__pre-header">
                  <table>
                    <thead>
                      <tr>
                        <th className="no-border">Мгновенная</th>
                      </tr>
                      <tr>
                        <th style={{ borderLeft: "none" }}>квт</th>
                      </tr>
                    </thead>
                  </table>
                </th>
                <th colSpan={2} scope="col" className="read-data-view-table__pre-header">
                  <table>
                    <thead>
                      ...
                      <tr>
                        <th style={{ minWidth: 100, borderLeft: "none" }}>квт</th>
                        <th style={{ minWidth: 100 }}>Время</th>
                      </tr>
                    </thead>
                  </table>
                </th>
                ...
                tableData.map((meter, index) => {
                  return (
                    ...
                    >
                      ...
                      <td style={{ minWidth: 100 }}> {meter.power !== null ? meter.power.instantKw : "-"}</td>
                      <td style={{ minWidth: 100 }}> {meter.power !== null ? meter.power.maxKw : "-"}</td>
                      <td style={{ minWidth: 100 }}>
                        {meter.power?.maxKwFixedTime
                          ? moment(meter.power.maxKwFixedTime).format("DD.MM.YYYY HH:mm")
                          : "-"}
                      </td>
        ...
        <div className="d-flex justify-content-between">
          ...
          <ExcelButton onClick={() => saveExcelCallBack && saveExcelCallBack()} />
        </div>
      </div>
    </div>
  );
