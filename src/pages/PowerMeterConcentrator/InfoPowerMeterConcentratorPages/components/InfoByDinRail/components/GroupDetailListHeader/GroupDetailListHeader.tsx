...
export const GroupDetailListHeader: FC<PropsType> = (props) => {
  const { selectedGroup, filterRef } = props;
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div style={{ display: "flex" }}>
              ...
              <AddButton
                ...
                onClick={() => history.push("/admin/concentrators/power-meter/add-concentrator/connection-by-dinRail")}
              />
            </div>
          </div>
        )}
