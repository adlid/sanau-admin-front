...
import { ConcentratorGRPSItemSideBar } from "../InfoByTCP/components/ConcentratorItemSideBar/ConcentratorGRPSItemSideBar";
import { GroupDetailListHeader } from "./components/GroupDetailListHeader";

const useStyle = makeStyles((theme) => ({ root: { color: "#B9BEC7" } }));

export const InfoByGPRSDynamic: FC = () => {
  // hooks
  ...
  useEffect(() => {
    dispatch(getGPRSMetersList({ text: inputValue, queryType: categoryValue, folderId: "", type: "DYNAMIC" }));
  }, []);
    ...
    <>
      ...
      <div className="info-by-transmision-device">
        <div className="info-by-transmision-device__wrap d-flex">
          ...
          <div>
            <GroupDetailListHeader selectedGroup={{ name: [folder] }} type="DYNAMIC" />
              ...
              <div className="d-flex">
                <InputGroup className="info-by-bluetooth__filter">
                  ...
                  <InputGroup.Prepend>
                    <div
                      onClick={() => {
                        dispatch(getGPRSMetersList({ text: inputValue, queryType: categoryValue, folderId: selectedFolderId, type: "DYNAMIC" }));
                        // setPage(1);
