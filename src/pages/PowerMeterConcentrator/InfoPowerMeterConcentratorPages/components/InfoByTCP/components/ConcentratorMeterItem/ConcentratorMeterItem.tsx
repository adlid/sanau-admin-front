...
import { setSelectedEditGprsMeterId } from "../../../../../../../store/slicesAndThunks/powerConcentrator/gprs/gprs.slice";

type PropsType = {
  meterData: GPRSListResponseType;
  openSidebar: any;
  setSelecteditem: any;
...
export const ConcentratorMeterItem: FC<PropsType> = (props) => {
  ...
  const handleEdit = async () => {
    await dispatch(setSelectedEditGprsMeterId(meterData.id))
    history.push("/admin/concentrators/power-meter/add-concentrator/connection-by-gprs/edit")
  }
