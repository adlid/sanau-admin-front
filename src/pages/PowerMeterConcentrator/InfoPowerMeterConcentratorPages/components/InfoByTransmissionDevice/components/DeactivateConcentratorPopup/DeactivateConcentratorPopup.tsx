...
export const DeactivateConcentratorPopup: FC<PropsType> = (props) => {
  ...
  return (
    <div className="delete-concentrator-popup__wrap">
      ...
      <div className="delete-concentrator-popup__body">
        Прибоы учета, связанные с УСПД перестанут считывать данные. Считанные ранее данные будут доступны к просмотру в
        течение 8 лет после деактивации.
      </div>
