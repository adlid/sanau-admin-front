...
import { uspdConcentratorGroupControlThunk } from "../../../../../../store/slicesAndThunks/powerConcentrator/transmissionDevice/transmissionDevice.thunk";
...
export const Taksonomy: FC<PropsType> = (props) => {
  ...
  const getGroupControlData = async () => {
    setDataLoading(true);
    await dispatch(uspdConcentratorGroupControlThunk(meterId));
  ...
  return (
    <div className="uspd-connection-taksonomy">
      {dataLoading ? (
