...
type PropsType = {
  formik: any;
  powerConcentratorPersonalAccountSearchCallback: () => void;
};

export const Counterparty: FC<PropsType> = ({ formik, powerConcentratorPersonalAccountSearchCallback }) => {
  return (
    <div className="edit-power-lorawan-concentrator-counterparty">
      <div className="edit-power-lorawan-concentrator-counterparty__header d-flex">
        ...
        <div className="edit-power-lorawan-concentrator-counterparty__btn" style={{ marginTop: "31px" }}>
          <MainButton
            isSecondary
            ...
            onClick={(e) => {
              e.preventDefault();
              powerConcentratorPersonalAccountSearchCallback();
            }}
          />
        </div>
      </div>

      <div className="edit-power-lorawan-concentrator-counterparty__border">
        <div className="edit-power-lorawan-concentrator-counterparty__role d-flex">
          <Form.Group>
            <Form.Check
        ...
        {formik.values.roleName === "ROLE_LEGAL" && (
          <Form.Group className="concentrator-character__form-item edit-power-lorawan-concentrator-counterparty__input">
      ...
      <div className="edit-power-lorawan-concentrator-counterparty__border">
        ...
        <div className="d-flex">
          ...
          <div className="mr16px"></div>
          <Form.Group className="concentrator-character__form-item edit-power-lorawan-concentrator-counterparty__short-input">
